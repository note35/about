...
export const AboutItems = [
  {
    ...
    "name": "Expertise 🎯",
    "description": "I currently lead cross‑organization solution initiatives. Over the past years my focus has evolved from full‑stack web‑application development and product ownership to architecting large‑scale systems. For a detailed overview, please see my <a href='https://note35.github.io/about/resume'>résumé</a>."
  }, {
    "name": "Python Community 🐍",
    "description": "Since 2017, I have been an active organizer for <a href='https://tw.pycon.org/' target='_blank' rel='noopener noreferrer'>PyCon Taiwan</a>, focusing on content creation and management. In this role, I regularly review conference proposals (CFPs) and am a frequent speaker. My involvement expanded to the global Python community in 2018, and I have since attended PyCon US, EuroPython, and PyCon JP. Most recently, I volunteered for EuroPython 2025, serving as both a CFP reviewer and a session chair. In addition, I make occasional contributions to OSS and the broader Python ecosystem, though my core focus remains on delivering enterprise solutions."
  }, {
    "name": "Programming Languages 🗣️",
    "description": "My expertise covers systems programming and backend development, with deep knowledge ranging from Python interpreter internals to large-scale C++ and Java systems to data analysis with SQL and Colab. I care about language fundamentals when they matter, but I'm tool-agnostic when solving practical problems."
  }, {
    "name": "Ongoing Works ⚡",
    "description": "Music, OSS, LLM, PLDI",
  }, {
    "name": "Past Studies 🪦",
    ...
    "name": "Music 🎵",
    "description": "I wish I can be a musician one day so I am actively working on it now, you can find my Jazz piano practice in <a href='https://www.instagram.com/kir_piano_practice/' target='_blank' rel='noopener noreferrer'>IG: kir_piano_practice</a>."
  }
]
